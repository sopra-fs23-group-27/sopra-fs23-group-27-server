...
public class PlayerService {
    ...
    public Player updatePlayer(long playerId, PlayerPutDTO playerUpdateRequest, String token) {
        ...
        if (
            (playerUpdateRequest.getPlayerName() != null && !playerUpdateRequest.getPlayerName().equals(playerToBeUpdated.getPlayerName())) ||
            (playerUpdateRequest.getPlayerName() != "" && !playerUpdateRequest.getPlayerName().equals(playerToBeUpdated.getPlayerName()))
            ) {
